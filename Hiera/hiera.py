...
from Hiera.hiera_utils import pretrained_model, conv_nd, do_pool, do_masked_conv, Unroll, Reroll
from Hiera.hfhub import has_config, PyTorchModelHubMixin
...
hiera_b = hiera_base_16x224().cuda()
hiera_b.head = nn.Identity()
...
hiera_b.load_state_dict(state_dict['model_state'], strict=False)
